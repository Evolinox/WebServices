...
func (r *ProductAPIRepository) GetProducts() ([]dto.ProductDTO, error) {
...
func (r *ProductAPIRepository) GetProductByID(id string) (*dto.ProductDTO, error) {
...
// ToDo Fehler bei Get mit Namen
func (r *ProductAPIRepository) GetProductByName(name string) ([]dto.ProductDTO, error) {
